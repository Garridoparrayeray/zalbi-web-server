...
function zalbi_setup() {
	/*
		...
		* If you're building a theme based on zalbi-theme, use a find and replace
		* to change 'zalbi' to the name of your theme in all the template files.
		*/
...
function zalbi_register_hinchables() {
    $args = array(
        ...
        'rewrite' => array( 'slug' => 'hinchable' ), // La URL será /hinchable/nombre-producto
    );
...
function zalbi_register_taxonomies() {
    register_taxonomy( 'tipo_hinchable', 'hinchable', array(
        ...
        'hierarchical' => true, // Comportamiento como categorías
...
function zalbi_register_eventos() {
    $args = array(
        ...
        'public' => true,
        'has_archive' => false,
        'menu_icon' => 'dashicons-calendar-alt', // Icono de calendario
        'supports' => array( 'title', 'editor', 'thumbnail', 'excerpt' ),
